...
# Approfondir : Appliquer avec données N dimension, Clustering Spatiale (RGBXY), Visualisation resultat, alpha coupe, Comparer a K-means
...
parser = argparse.ArgumentParser(description='FCM Params')
...
C = np.random.randint(0, 255, size=(args.k_clusters, 3))
Co = np.copy(C)
